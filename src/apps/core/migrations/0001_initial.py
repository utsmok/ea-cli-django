    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('v2_manual_classification', models.CharField(choices=[('Ja (open licentie)', 'Ja (Open Licentie)'), ('Ja (eigen werk)', 'Ja (Eigen Werk)'), ('Ja (easy access)', 'Ja (Easy Access)'), ('Nee', 'Nee'), ('Onbekend', 'Onbekend')], db_index=True, default='Onbekend', max_length=100)),
                ('v2_overnamestatus', models.CharField(choices=[('Overname (inbreukmakende)', 'Inbreukmakend'), ('Geen overname', 'Geen Overname'), ('Onbekend', 'Onbekend')], default='Onbekend', max_length=100)),
