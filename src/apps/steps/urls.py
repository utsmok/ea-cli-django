...
urlpatterns = [
    ...
    path("enrich-osiris/status/", views.enrich_osiris_status, name="enrich_osiris_status"),
    ...
    path("enrich-people/status/", views.enrich_people_status, name="enrich_people_status"),

    # Step 5: Get PDF Status from Canvas
    path("pdf-canvas-status/", views.pdf_canvas_status_step, name="pdf_canvas_status"),
    path("pdf-canvas-status/run/", views.run_pdf_canvas_status, name="run_pdf_canvas_status"),
    path("pdf-canvas-status/status/", views.pdf_canvas_status_status, name="pdf_canvas_status_status"),
